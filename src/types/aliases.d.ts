// Ambient module declarations to support version-suffixed imports used in the codebase.
// These re-export types and values from the actual packages without versions.
